        ...
        switch (data.method) {
            ...
            case 'create':
                ...
                cells.forEach(cell => {
                    ...
                    cell.classList.remove('cirlce')//cirlce
                })
                break
            ...
            case 'join':
                ...
                cells.forEach(cell => {
                    ...
                    cell.classList.remove('s')
                    cell.classList.remove('circle')//cirlce
            ...
            case 'updateBoard':
                ...
                game = data.game
                board = game.board
                const symbolClass = yourSymbol == 's' ? 's' : 'circle'
            ...
            case 'gameEnds':
                console.log(`Kazanan  ${data.winner}`)
                window.alert(`Kazanan  ${data.winner}`)
                break;
            case 'draw':
                alert('Berabere')
                break
...
function clickCell(event) {
    ...
    if (!isTurn || event.target.classList.contains('s') || (event.target.classList.contains('circle')))
        return

    const cellclass = yourSymbol == 's' ? 's' : 'circle'
